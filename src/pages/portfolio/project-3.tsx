...
const Project3 = () => { // Slug Number
    const project = { 
        title: 'Logo Designs',
        category: 'Graphics Design',
        description: 'A collection of logo designs for various clients. Each logo is designed to be unique and memorable, reflecting the brand identity of the client.',
        featuredImage: '/Logo8.png',
        additionalImages: [
            '/Logo1.png',
            '/Logo2.png',
            '/Logo3.png',
